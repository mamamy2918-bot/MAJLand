      ...
      switch (path) {
        case "/api/newsletter/subscribe":
          if (request.method === "POST") {
            return await handleNewsletterSubscription(request, env2, userId);
          }
          break;
        case "/api/contact":
          if (request.method === "POST") {
            return await handleContactSubmission(request, env2, userId);
          }
          break;
        case "/api/admin/subscribers":
          if (request.method === "GET") {
            return await handleGetSubscribers(request, env2, userId);
          }
          break;
        case "/api/admin/contacts":
          if (request.method === "GET") {
            return await handleGetContacts(request, env2, userId);
          }
          break;
        case "/health":
...
async function handleNewsletterSubscription(request, env2, userId) {
  const corsHeaders = {
    "Access-Control-Allow-Origin": "*",
  ...
  try {
    ...
    console.error("Newsletter subscription error:", error3);
    return new Response(JSON.stringify({
...
__name(handleNewsletterSubscription, "handleNewsletterSubscription");
async function handleContactSubmission(request, env2, userId) {
  const corsHeaders = {
    "Access-Control-Allow-Origin": "*",
    "Content-Type": "application/json"
  };
  try {
    ...
    console.error("Contact submission error:", error3);
    return new Response(JSON.stringify({
...
async function handleGetSubscribers(request, env2, userId) {
  const corsHeaders = {
    "Access-Control-Allow-Origin": "*",
    "Content-Type": "application/json"
  };
  try {
    ...
    console.error("Get subscribers error:", error3);
    return new Response(JSON.stringify({
...
__name(handleGetSubscribers, "handleGetSubscribers");
async function handleGetContacts(request, env2, userId) {
  const corsHeaders = {
    "Access-Control-Allow-Origin": "*",
    "Content-Type": "application/json"
  };
